...
var store = new products_1.ProdcutStore();
...
var category = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var category, products;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                category = _req.params.category;
                return [4 /*yield*/, store.category(category)];
            case 1:
                products = _a.sent();
                res.json(products);
                return [2 /*return*/];
...
var topProducts = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var products;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.top()];
            case 1:
                products = _a.sent();
                res.json(products);
                return [2 /*return*/];
